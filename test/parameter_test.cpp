...
namespace {
using pack = xenium::parameter::pack<xenium::policy::entries_per_node<42>,
...
TEST(Parameter, type_param_extracts_value_from_specified_policy) {
  constexpr auto entries_per_node =
    xenium::parameter::value_param<unsigned, xenium::policy::entries_per_node, pack, 0>::value;
